...
var valsplit = "=";
var firstload = true;
var ommitbuttons = ["", "c_mainpg", "sidebarToggle", "facrst", "zrfl", "strtrcv", "srac", "loginbtn", "downloadLogBtn", "downloadcomdata", "rebot", "downloadAndLogBtn"];
...
function sendtoserver(sdatastr) {
  if (sdatastr != false) {
    $.ajax({
      url: "http://192.168.4.245/datamgmt.html",
      method: "POST",
      data: sdatastr
    }).done(function (rdata) {
      placealldata(rdata);
...
function btnclick_actions(currelement, context, isconfirmationreq) {
  ...
  if (!(currpage == "diag.html" || currpage == "index.html" || currpage == "login.html" || currpage == "trends.html" || currpage == "" || firstload == true || id == "loginbtn" || id == "ct_p" || id == "sidebarToggle" || isconfirmationreq != true)) {
...
function setrecursivecalls() {
  if (currpage == "diag.html" || currpage == "index.html" || currpage == "allparams.html" || currpage == "trends.html") {
