...
} // Retrieve color from local storage and set it on page load
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (savedColor) {
    var colorElement = document.querySelector('[data-color="' + savedColor + '"]');
...
function sidebarType(a) {
  ...
  sidebar.classList.add(type); // Handle dark version

  if (type == 'dark-version') {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (savedType) {
    var typeElement = document.querySelector('[data-class="' + savedType + '"]');
...
function navbarColorOnResize() {
  if (window.innerWidth > 1200) {
    if (referenceButtons.classList.contains('active') && referenceButtons.getAttribute('data-class') === 'bg-transparent') {
      sidenav.classList.remove('bg-white'); // location.reload();
    } else {
      if (!body.classList.contains('dark-version')) {
        sidenav.classList.add('bg-white'); // location.reload();
      }
    }
  } else {
    sidenav.classList.add('bg-white');
    sidenav.classList.remove('bg-transparent'); // location.reload();
  }
...
function darkMode(el) {
  ...
  var btnWhite = document.querySelector('[data-class="bg-white"]');
  var btnDark = document.querySelector('[data-class="bg-default"]');
...
document.addEventListener('DOMContentLoaded', function () {
  var el = document.querySelector('#dark-version');
