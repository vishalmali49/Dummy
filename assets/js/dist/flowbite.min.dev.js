...
!function (t, e) {
  ...
  return function () {
    ...
    var t = {
      ...
      316: function _(t, e, i) {
        var n = this && this.__assign || function () {
          ...
          if (i || 2 === arguments.length) for (var n, o = 0, r = e.length; o < r; o++) {
    ...
    return function () {
      ...
      i(311);
      var g = i(947);
      new g["default"]("load", [e.initAccordions, r.initCollapses, o.initCarousels, a.initDismisses, d.initDropdowns, l.initModals, c.initDrawers, p.initTabs, h.initTooltips, u.initPopovers, s.initDials, v.initCopyClipboards, f.initInputCounters]).init(), t["default"] = {
        Accordion: e["default"],
        Carousel: o["default"],
        Collapse: r["default"],
        Dial: s["default"],
