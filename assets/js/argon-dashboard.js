...
function darkMode(el) {
  ...
  const btnWhite = document.querySelector('[data-class="bg-white"]');
  const btnDark = document.querySelector('[data-class="bg-default"]');
...
document.addEventListener('DOMContentLoaded', () => {
  const el = document.querySelector('#dark-version');
